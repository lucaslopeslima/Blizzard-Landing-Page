...
- [x]  Uma scrollbar discreta e estilizada no mesmo padrão da página;

- [x]  Coloquei uma animação hover nos itens do menu dropdown de e-sports, com grayscale.

- [x]  Acrescentei responsividade para tela 475px;
